import type { DocPage, DocsForPhase, PhaseId } from "@/lib/types";
...
export const DEV_UNIT_TEST_REPORT_V2: DocPage = {
...
// Each phase's report tabs map 1:1 to the agents listed in data/agents.ts —
// so a stakeholder reviewing the phase report sees exactly one document per
// agent that ran.

export const DOCS: Partial<Record<PhaseId, DocsForPhase>> = {
  req: {
