// src/data/brdData.js
const INIT_PASTE = 'I need to create simple ABC bank application with login credential. it should automatically create bank application and run with different port';
